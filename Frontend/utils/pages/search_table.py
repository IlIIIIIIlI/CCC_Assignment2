...
def search_table():
    ...
    def download_files():
        ...
        if os.path.exists("./utils/models/shakespeare-index-full/embeddings"):
            pass
        else:
            output = "./utils/models/shakespeare-index-full/embeddings"
    ...
    def load_txtai():
        ...
        embeddings.load("./utils/models/shakespeare-index-full")
        return embeddings

    @st.cache_resource
    def load_df():
        df = pd.read_csv("./utils/data/shakespeare.csv")
        return df
