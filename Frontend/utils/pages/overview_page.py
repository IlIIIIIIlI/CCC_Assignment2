...
def overview_page():
    ...
    st.image("https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/325/bar-chart_1f4ca.png",
             width=100)
    ...
    if use_example_file:
        uploaded_file = "./utils/data/Website_Results.csv"
        ab_default = ["variant"]
